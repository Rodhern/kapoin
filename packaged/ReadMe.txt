...
At present the Kapoin add-on is 'mostly empty', in the sense that it does not do very much. The test at this point is to install it, and check the logs, that the add-on is loaded, and that it does not throw exceptions left and right.
